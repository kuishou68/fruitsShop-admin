  ...
  "info": ""
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field('title,type,pay_type,total_fee,platform,status,is_refund,refund_amount,refund_count,create_time,update_time,paid_time,refund_time,refund_desc,transaction_id,info').get().then((res) => {
